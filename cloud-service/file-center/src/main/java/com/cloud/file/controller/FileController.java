...
public class FileController {
	...
	@PostMapping
	public FileInfo upload(@RequestParam("file") MultipartFile file, String fileType) throws Exception {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(value = "layui富文本文件上传",notes = "layui富文本文件上传")
	@LogAnnotation(module = "文件上传", recordParam = false)
	@PostMapping("/layui")
	 ...
	 * @param id
	 */
	@ApiOperation(value = "文件删除",notes = "权限：“file:del”，文件删除")
	 ...
	 * @return
	 */
	@ApiOperation(value = "文件查询",notes = "权限：“file:query”，文件查询")
