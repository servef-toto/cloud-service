...
public class SwaggerConfig {
	...
	public Docket docket() {
		return new Docket(DocumentationType.SWAGGER_2).groupName(StringUtils.isEmpty(groupName)?"认证中心swagger接口文档":groupName)
				.apiInfo(new ApiInfoBuilder().title(StringUtils.isEmpty(title)?"认证中心swagger接口文档":title)
